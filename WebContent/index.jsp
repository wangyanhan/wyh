...
<body>
	...
	%>
		...
		%>							<a href="QueryStudentByPage?currentPage=<%=p.getCurrentPage()+1%>&pageSize=<%=p.getPageSize()%>">下111一页</a>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$("select").change(function(){
				...
				location.href = "QueryStudentByPage?currentPage=<%=p.getCurrentPage()%>&pageSize="+$(this).val();
